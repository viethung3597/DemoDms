...
export const ProductsApi = {
  ...
  /**
   * Create a request builder for execution of delete requests to the '/api/Products' endpoint.
   * @param queryParameters - Object containing the following keys: id.
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  deleteApiProducts: (queryParameters?: {'id'?: number}) => new OpenApiRequestBuilder<any>(
    'delete',
    '/api/Products',
    {
          queryParameters
  ...
  /**
   * Create a request builder for execution of get requests to the '/api/Products/{search}' endpoint.
   * @param search - Path parameter.
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  getApiProductsBySearch: (search: string) => new OpenApiRequestBuilder<Product[] | any>(
    'get',
    '/api/Products/{search}',
    {
