...
const EditableTable = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      // render: (value: any) =>
      //   <Select>
      //     <Select.Option value={value = 0}>Không xác định</Select.Option>
      //     <Select.Option value={value = 1}>Đồ ăn</Select.Option>
      //     <Select.Option value={value = 2}>Đồ uống</Select.Option>
      //   </Select>,
      editable: true,
    },
    {
  ...
  return (
    <Form form={form} component={false}>
      ...
      <Table
        ...
        pagination={
          { defaultCurrent: 1, total: totalItem, defaultPageSize: 5, showSizeChanger: true, pageSizeOptions: [10, 20, 50, 100] }
        }
        onChange={onChange}
      />
    </Form>
